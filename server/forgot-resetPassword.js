...
const sendResetPasswordLink = async (name,  username,email) => {
    try {
      ...
      const mailOptions = {
        ...
        <![endif]--><a href="http://127.0.0.1:3080/resetPassword?user=${username}" target="_blank" style="text-decoration:none;display:inline-block;color:#ffffff;background-color:#03191e;border-radius:4px;width:auto;border-top:1px solid #03191E;font-weight:undefined;border-right:1px solid #03191E;border-bottom:1px solid #03191E;border-left:1px solid #03191E;padding-top:5px;padding-bottom:5px;font-family:Arial, Helvetica Neue, Helvetica, sans-serif;font-size:16px;text-align:center;mso-border-alt:none;word-break:keep-all;"><span style="padding-left:20px;padding-right:20px;font-size:16px;display:inline-block;letter-spacing:normal;"><span style="word-break: break-word; line-height: 32px;">Reset Password</span></span></a><!--[if mso]></center></v:textbox></v:roundrect><![endif]--></div>
                                      </td>
                                    </tr>
                                  </table>
                                    ...
                                    <tr>
                                      <td class="pad">
                                        <div style="color:#101112;direction:ltr;font-family:Arial, Helvetica Neue, Helvetica, sans-serif;font-size:16px;font-weight:400;letter-spacing:0px;line-height:120%;text-align:center;mso-line-height-alt:19.2px;">
                                          <p style="margin: 0;"><span style="color: #ffffff;">BlackPanda Copyright © 2023</span></p>
                                        </div>
                                      </td>
                                    </tr>
                                  </table>
